...
WITH eliflg AS (
  ...
  SELECT
    ...
    CASE
      ...
      ELSE 0
    END AS carddrg,
    CASE WHEN d.drg_code BETWEEN 299 AND 301 THEN 1 ELSE 0 END AS peridrg,
    CASE
      WHEN d.drg_code = 652
      THEN 1
    ...
    CASE
      ...
      ELSE 0
    END AS pulmdrg,
    CASE WHEN d.drg_code BETWEEN 637 AND 639 THEN 1 ELSE 0 END AS DIABDRG,
    CASE
    ...
    CASE
      ...
      ELSE 0
    END AS liverdrg,
    CASE WHEN d.drg_code BETWEEN 377 AND 384 THEN 1 ELSE 0 END AS ulcedrg,
    CASE
    ...
    CASE
      ...
      ELSE 0
    END AS cancdrg,
    CASE WHEN d.drg_code BETWEEN 545 AND 547 THEN 1 ELSE 0 END AS arthdrg,
    CASE WHEN d.drg_code BETWEEN 640 AND 641 THEN 1 ELSE 0 END AS nutrdrg,
    CASE WHEN d.drg_code BETWEEN 808 AND 812 THEN 1 ELSE 0 END AS anemdrg,
    CASE WHEN d.drg_code BETWEEN 894 AND 897 THEN 1 ELSE 0 END AS alcdrg,
    CASE WHEN d.drg_code = 813 THEN 1 ELSE 0 END AS coagdrg,
    CASE
      WHEN d.drg_code = 077
      THEN 1
      WHEN d.drg_code = 078
      ...
      ELSE 0
    END AS htncxdrg,
    CASE WHEN d.drg_code = 079 THEN 1 WHEN d.drg_code = 305 THEN 1 ELSE 0 END AS htndrg,
    CASE WHEN d.drg_code = 885 THEN 1 ELSE 0 END AS psydrg,
    CASE WHEN d.drg_code BETWEEN 619 AND 621 THEN 1 ELSE 0 END AS obesedrg,
  ...
  SELECT
    ...
    CASE
      ...
      ELSE 0
    END AS carddrg,
    CASE WHEN d.drg_code = 130 THEN 1 WHEN d.drg_code = 131 THEN 1 ELSE 0 END AS peridrg,
    CASE
    ...
    CASE
      ...
      ELSE 0
    END AS ceredrg,
    CASE WHEN d.drg_code = 88 THEN 1 WHEN d.drg_code BETWEEN 96 AND 98 THEN 1 ELSE 0 END AS pulmdrg,
    CASE WHEN d.drg_code = 294 THEN 1 WHEN d.drg_code = 295 THEN 1 ELSE 0 END AS diabdrg,
    CASE
      WHEN d.drg_code = 290
      THEN 1
      WHEN d.drg_code = 300
    ...
    CASE
      ...
      ELSE 0
    END AS liverdrg,
    CASE WHEN d.drg_code BETWEEN 174 AND 178 THEN 1 ELSE 0 END AS ulcedrg,
    CASE
      WHEN d.drg_code = 488
      THEN 1
      WHEN d.drg_code = 489
    ...
    CASE
      ...
      ELSE 0
    END AS cancdrg,
    CASE WHEN d.drg_code = 240 THEN 1 WHEN d.drg_code = 241 THEN 1 ELSE 0 END AS arthdrg,
    CASE WHEN d.drg_code BETWEEN 296 AND 298 THEN 1 ELSE 0 END AS nutrdrg,
    CASE
      WHEN d.drg_code = 395
      THEN 1
      WHEN d.drg_code = 396
    ...
    CASE
      ...
      ELSE 0
    END AS alcdrg,
    CASE WHEN d.drg_code = 397 THEN 1 ELSE 0 END AS coagdrg,
    CASE WHEN d.drg_code = 22 THEN 1 WHEN d.drg_code = 134 THEN 1 ELSE 0 END AS htncxdrg,
    CASE WHEN d.drg_code = 134 THEN 1 ELSE 0 END AS htndrg,
    CASE WHEN d.drg_code = 430 THEN 1 ELSE 0 END AS psydrg,
    CASE WHEN d.drg_code = 288 THEN 1 ELSE 0 END AS obesedrg,
...
SELECT
  ...
  CASE WHEN carddrg = 1 THEN 0 WHEN arythm = 1 THEN 1 ELSE 0 END AS cardiac_arrhythmias,
  ...
  CASE WHEN peridrg = 1 THEN 0 WHEN perivasc = 1 THEN 1 ELSE 0 END AS peripheral_vascular,
  CASE
    WHEN (
      CASE WHEN htndrg = 0 THEN 0 WHEN htn = 1 THEN 1 ELSE 0 END
    ) + (
      CASE
