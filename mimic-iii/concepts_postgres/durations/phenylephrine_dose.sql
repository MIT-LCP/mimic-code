...
DROP TABLE IF EXISTS mimiciii_derived.phenylephrine_dose; CREATE TABLE mimiciii_derived.phenylephrine_dose AS
/* This query extracts dose+durations of phenylephrine administration */ /* Get drug administration data from CareVue first */
WITH vasocv1 AS (
  SELECT
    icustay_id,
