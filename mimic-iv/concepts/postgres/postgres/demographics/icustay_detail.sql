...
, ROUND( CAST(  CAST( DATETIME_DIFF(ie.outtime,ie.intime,'HOUR')/24.0 as numeric),2) as los_icu
 as numeric),DENSE_RANK() OVER (PARTITION BY ie.hadm_id ORDER BY ie.intime) AS icustay_seq
