...
WITH ce AS (
    SELECT ce.stay_id
        ...
        -- metavision itemids
            ...
            WHEN ce.itemid IN
                (
                    -- | Hemodialysis Output                               | Dialysis
                    226499
                    -- | Dialysate Rate                                    | Dialysis
                    , 224154
                    -- | Dwell Time (Peritoneal Dialysis)                  | Dialysis
                    , 225810
                    -- | Medication Added Amount  #1 (Peritoneal Dialysis) | Dialysis
                    , 225959
                    -- | Medication Added Amount  #2 (Peritoneal Dialysis) | Dialysis
                    , 227639
            ...
            WHEN ce.itemid IN
                (
                    ...
                    -- | Dialysis Catheter Site Appear | Access Lines - Invasive
                    , 225323
                    -- | Dialysis Catheter Discontinued | Access Lines - Invasive
                    , 225740
                    -- | Dialysis Catheter Dressing Type | Access Lines - Invasive
                    , 225776
                    -- | Peritoneal Dialysis Fluid Appearance | Dialysis
                    , 225951
                    -- | Medication Added #1 (Peritoneal Dialysis) | Dialysis
                    , 225952
                    ...
                    -- | Medication Added Units #1 (Peritoneal Dialysis) | Dialysis
                    , 225961
                    ...
                    -- | Medication Added #2 (Peritoneal Dialysis) | Dialysis
                    , 227638
                    -- | Medication Added Units #2 (Peritoneal Dialysis) | Dialysis
                    , 227640
    ...
    WHERE ce.itemid IN
        (
            ...
            -- | Dialysis Site Appearance | Dialysis | chartevents | Text
            , 224139
            ...
            -- | Solution (Peritoneal Dialysis) | Dialysis | chartevents | Text
            , 225953
            , 225954 -- | Dialysis Access Type | Dialysis | chartevents | Text
            -- | Reason for CRRT Filter Change | Dialysis | chartevents | Text
            , 225956
            -- | Heparin Concentration (units/mL) | Dialysis | chartevents | Text
            , 225958
            , 225961 -- | Medication Added Units #1 (Peritoneal Dialysis) | Dialysis | chartevents | Text
            -- | Peritoneal Dialysis Catheter Type | Dialysis | chartevents | Text
            , 225963
            -- | Peritoneal Dialysis Catheter Status | Dialysis | chartevents | Text
            , 225965
