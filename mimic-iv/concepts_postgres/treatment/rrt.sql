  ...
  SELECT
    ...
    CASE
      ...
      WHEN ce.itemid IN (
        ...
        225806, /* | Volume In (PD) */
        225807, /* | Volume Out (PD) */ /* | Dwell Time (Peritoneal Dialysis) */
        225810, /* | Medication Added Amount  #2 (Peritoneal Dialysis) */
        227639, /* | Medication Added Amount  #1 (Peritoneal Dialysis) */
        225959, /* | Peritoneal Dialysis Fluid Appearance */
        225951, /* | Medication Added #1 (Peritoneal Dialysis) */
        225952, /* | Medication Added Units #1 (Peritoneal Dialysis) */
        225961,
        225953, /* | Solution (Peritoneal Dialysis) */
        225963, /* | Peritoneal Dialysis Catheter Type */
        225965, /* | Peritoneal Dialysis Catheter Status */ /* | Medication Added #2 (Peritoneal Dialysis) */
        227638, /* | Medication Added Units #2 (Peritoneal Dialysis) */
        227640
      )
      THEN 'Peritoneal'
