...
\COPY mimic_hosp.admissions FROM PROGRAM '7z e -so admissions.csv.gz' DELIMITER ',' CSV HEADER NULL '';
...
\COPY mimic_hosp.omr FROM PROGRAM '7z e -so omr.csv.gz' DELIMITER ',' CSV HEADER NULL '';
\COPY mimic_hosp.patients FROM PROGRAM '7z e -so patients.csv.gz' DELIMITER ',' CSV HEADER NULL '';
...
\COPY mimic_hosp.transfers FROM PROGRAM '7z e -so transfers.csv.gz' DELIMITER ',' CSV HEADER NULL '';
...
\COPY mimic_icu.ingredientevents FROM PROGRAM '7z e -so ingredientevents.csv.gz' DELIMITER ',' CSV HEADER NULL '';
