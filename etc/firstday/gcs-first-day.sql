...
drop materialized view gcsfirstday;
...
, gcs as (
  ...
  , case
      -- replace GCS of 3 due to sedation with 15
      when b.GCSVerbal = 0 and b.GCSMotor = 1 and b.GCSEyes = 1
        then 15
      -- if intubated/trach'd, replace GCS verbal with 5
      when b.GCSVerbal = 0
        then coalesce(b.GCSMotor,coalesce(b2.GCSMotor,6)) + 5 + coalesce(b.GCSEyes,coalesce(b2.GCSEyes,4))
      -- otherwise, add up score normally
      when b.GCSVerbal is null and b2.GCSVerbal != 0
        then coalesce(b.GCSMotor,coalesce(b2.GCSMotor,6)) + b2.GCSVerbal + coalesce(b.GCSEyes,coalesce(b2.GCSEyes,4))
      else coalesce(b.GCSMotor,coalesce(b2.GCSMotor,6)) + b.GCSVerbal + coalesce(b.GCSEyes,coalesce(b2.GCSEyes,4)) end
      as GCS
...
, GCS as MinGCS
, GCSMotor as MinGCSMotor
, GCSVerbal as MinGCSVerbal
, GCSEyes as MinGCSEyes
