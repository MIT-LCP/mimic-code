...
CREATE TABLE MIMICIII.INPUTEVENTS_CV
   (	ROW_ID INT NOT NULL,
	SUBJECT_ID INT NOT NULL,
	HADM_ID INT,
	ICUSTAY_ID INT,
...
CREATE TABLE MIMICIII.INPUTEVENTS_MV
   (	ROW_ID INT NOT NULL,
	SUBJECT_ID INT NOT NULL,
	HADM_ID INT,
	ICUSTAY_ID INT,
...
CREATE TABLE MIMICIII.NOTEEVENTS
   (	ROW_ID INT NOT NULL,
	...
	CGID INT,
	ISERROR CHAR(1),
	TEXT VARCHAR(60000),-- 53000 is the max number char for now, then varchar is better than CLOB in interface such dbeaver
...
CREATE TABLE MIMICIII.OUTPUTEVENTS
   (	ROW_ID INT NOT NULL,
	SUBJECT_ID INT NOT NULL,
	HADM_ID INT,
	ICUSTAY_ID INT,
...
CREATE TABLE MIMICIII.PROCEDUREEVENTS_MV
   (	ROW_ID INT NOT NULL,
	SUBJECT_ID INT NOT NULL,
	HADM_ID INT NOT NULL,
	ICUSTAY_ID INT,
