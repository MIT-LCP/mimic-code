...
-- subject_id
ALTER TABLE ICUSTAYEVENTS DROP CONSTRAINT IF EXISTS icustayevents_fk_subject_id;
...
-- hadm_id
ALTER TABLE ICUSTAYEVENTS DROP CONSTRAINT IF EXISTS icustayevents_fk_hadm_id;
ALTER TABLE ICUSTAYEVENTS
...
-- subject_id
ALTER TABLE IOEVENTS DROP CONSTRAINT IF EXISTS ioevents_fk_subject_id;
...
-- hadm_id
ALTER TABLE IOEVENTS DROP CONSTRAINT IF EXISTS ioevents_fk_hadm_id;
ALTER TABLE IOEVENTS
...
-- icustay_id
ALTER TABLE IOEVENTS DROP CONSTRAINT IF EXISTS ioevents_fk_icustay_id;
ALTER TABLE IOEVENTS
...
-- cgid
ALTER TABLE IOEVENTS DROP CONSTRAINT IF EXISTS ioevents_fk_cgid;
ALTER TABLE IOEVENTS
