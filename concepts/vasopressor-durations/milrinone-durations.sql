...
DROP MATERIALIZED VIEW IF EXISTS MILRINONEDURATIONS;
CREATE MATERIALIZED VIEW MILRINONEDURATIONS as
...
(
  select
    ...
    , max(case when itemid = 30125       and stopped in ('Stopped','D/C''d') then 1
