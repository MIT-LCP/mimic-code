...
DROP MATERIALIZED VIEW IF EXISTS ISUPRELDURATIONS;
CREATE MATERIALIZED VIEW ISUPRELDURATIONS as
...
(
  select
    ...
    , max(case when itemid = 30046       and stopped in ('Stopped','D/C''d') then 1
